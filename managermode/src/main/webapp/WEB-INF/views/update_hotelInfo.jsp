...
<h5>변경하실 호텔 고유번호를 입력 후 이하 정보를 수정해주세요.</h5>
<div id="hotel-registration-form">
 <form id="hotelForm" action="${pageContext.request.contextPath}/default_num_check_update" method="post">
   	
    <div class="form-group">
        <label for="default_num">변경할 호텔 고유번호</label>
        <input type="text" id="default_num_insert" name="default_num" required>
    </div>
       ...
       <div class="form-row">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
            	...
            	<textarea id="coment" name="coment" rows="1"></textarea>
            </div>
        </div>
